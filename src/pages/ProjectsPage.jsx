...
const THUM_BASE = 'https://image.thum.io/get/width/400/crop/711';
...
function ThumbnailImage({ src, alt }) {
  ...
  return (
    /* 9:16 비율 고정 (177.78% = 16/9) */
    <Box sx={{ position: 'relative', width: '100%', paddingTop: '177.78%', flexShrink: 0, overflow: 'hidden' }}>
      {src && !imgError ? (
        <Box
          component="img"
          src={src}
